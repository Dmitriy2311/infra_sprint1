...
Блог для любителей котов! Можно добавлять фотографии, комментарии, а также рассказать какого они цвета и когда родились :)
...
```
git clone git@github.com:Dmitriy2311/infra_sprint1.git
```
